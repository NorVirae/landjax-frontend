      ...
      <main>
        ...
        <section className='house__preview'>
          ...
          <div className='house__preview-inner'>
            <Image src={HouseImg} height={"250rem"} objectFit width="200rem" className='house__image-preview'/>
            <Image src={HouseImg} height={"250rem"} width="200rem" className='house__image-preview'/>
            <Image src={HouseImg} height={"250rem"} width="200rem" className='house__image-preview'/>
            <Image src={HouseImg} height={"250rem"} width="200rem" className='house__image-preview'/>
            <Image src={HouseImg} height={"250rem"} width="200rem" className='house__image-preview'/>
            <Image src={HouseImg} height={"250rem"} width="200rem" className='house__image-preview'/>
